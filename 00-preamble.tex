...
\Abstract{%
    ...
    its Lattice Gas Automata (LGA) predecessor, up to the present time. Findings include multiple lattice categories,  competing
    naming standards, ambiguous names particularly in higher-order models, naming systems of varying model parameter scopes, and
    lack of unambiguous naming schemes.
}
%-------------------------------------------------------------------------------------------------------------------------------
