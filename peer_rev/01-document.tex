...
\section{Lattice Nomenclature Survey}
    ...
    lengths was proposed---which was named `face-centered rectangular' by the author---whose weights exactly  recover  those  of
    the well-known D2Q9 lattice for $a = b$, over which the argument that valid weights `[...]  \emph{can  always  be  found  by
    choosing a large enough set of} (lattice) \emph{velocity vectors\/} [...]'~\cite{1991-KoelmanJMVA-EuroPhysLett}.
...
\section{Discussion}
    ...
    types  and  features,  as  well  as  of  the   existence   of   any   concise   \emph{naming}---as   opposed   to   velocity
