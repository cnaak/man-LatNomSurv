...
\section{Discussion}
    ...
    (hexagonal) 2D spaces, and cubic ones in 3D spaces; (b)~irregular, non-space-filling ones; and those (c)~based on  spherical
    coordinate systems. Moreover, there are even those with (d)~shifted reference frame; and those (e)~more heavily  focused  on
