...
\section{Discussion}
    ...
    Notwithstanding, all `mainstream' lattice naming schemes---whether `$E_{D,n}^{d}$', `DdQb' and its variations---were all
    found to suffer from ambiguity, as, for instance `D2Q25' (or `D2V25', or `D2Q$5^2$') \emph{can} mean many different things,
    have completely different envelope shapes, conception strattegy, different populated energy levels, and optional
    shiftings...
