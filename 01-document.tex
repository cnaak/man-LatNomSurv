...
\section{Discussion}
    ...
    coworkers~\cite{2006-PhilippiPC+SurmasR-PhysRevE},    and    the    `DdQb-ZOT'    one    due     to     Chikatamarla     and
    Karlin~\cite{2008-ChikatamarlaSS+KarlinIV-CompPhysComm} frequently  re-appear  in  many  subsequent  publications,  but  its
    adoption seem to be more or less confined to the proposing author's research groups, and to direct citations, so  that  such
    naming schemes appear to be in competition.
