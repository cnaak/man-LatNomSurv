...
\section{Lattice Nomenclature Survey}
    ...
    Most likely borrowing from mesh-based, continuous mechanics, numerical methods,  a  study~\cite{1996-HeX+DemboM-JComputPhys}
    has proposed a LB algorithm for non-uniform mesh grids, by decoupling spatial and momentum space discretizations in  the  LB
    ...
    model in 2D space' and semantic variations thereof, in which BGK stands for Kinetic theory's Bhatnagar-Gross-Krook collision
    model   for   the   continuous   Boltzmann    equation~\cite{1954-BhatnagarPL+KrookM-PhysRev,    2003-LiboffRL-bookSpringer,
    2011-HarrisS-Dover}.
