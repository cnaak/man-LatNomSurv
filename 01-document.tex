...
\section{Lattice Nomenclature Survey}
    ...
    2020-FrapolliN+KarlinIV-Entropy} mention a `$DdQn^d$' naming scheme, in which $d$ is the Euclidean space dimensionality  and
    $n^d$ is the lattice velocity count, and presents the $D2Q7^2$ lattice, i.e., a D2Q49 one,  in  the  (i)~symmetric  variety,
