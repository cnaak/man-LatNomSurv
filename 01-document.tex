...
\section{Lattice Nomenclature Survey}
    ...
    $\epsilon = 1^2 + 2^2 = 5$ energy level of a square  lattice,  represented  by  the  8  discrete  velocities  obtained  from
    permutations of ($\pm\{1,2\}$, $\pm\{2,1\}$) in lattice units. This is in contrast to the seemingly prevailing current  view
