...
\section{Discussion}
    ...
    From this lattice naming systems survey along the history of LM methods, one finds that many  lattice  naming  schemes  have
    appeared over the years, with each new variety either introduced as to accomodate or reflect a new  aspect  brought  in  the
    research, or to organize and distinguish multiple lattices within a publication.
