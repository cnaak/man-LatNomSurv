...
\section{Lattice Nomenclature Survey}
    ...
    right angles, which led to possibly multiple sublattices per lattice energy level $\epsilon \equiv 2e = c^2$, with $c$ being
    the microscopic (lattice) velocity magnitude, and $e$ the corresponding specific kinetic energy, as was the  case  with  the
