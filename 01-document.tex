...
\section{Discussion}
    ...
    Moreover, other naming conventions such as the `$E_{D,n}^{d}$' due to Shan and coworkers~\cite{2006-ShanX+ChenH-JFluidMech},
    the `DdVb' one due to  Philippi  and  coworkers~\cite{2006-PhilippiPC+SurmasR-PhysRevE},  and  the  `DdQb-ZOT'  one  due  to
    Chikatamarla  and  Karlin~\cite{2008-ChikatamarlaSS+KarlinIV-CompPhysComm}   frequently   re-appear   in   many   subsequent
    publications, but its adoption seem to be more or less confined to the proposing author's research  groups,  and  to  direct
    citations.
