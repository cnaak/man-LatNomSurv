...
\section{Discussion}
    ...
    many different lattice configurations, having completely different envelope shapes, conception strattegy, set  of  populated
    energy levels, and optional shiftings, since it only specifies a set of  25  discrete  velocities  in  two  Euclidean  space
    dimentions, and, in the case of the `$E_{D,n}^{d}$' scheme, the resulting order of approximation.
...
\section{Conclusions}
    ...
    between    models    of    same    dimensionality    and    velocity    count.    An     upcomming     work     from     the
